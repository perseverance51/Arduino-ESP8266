//AP Web Server
/*通过下面两个地址，来控制板载led灯亮灭
 * 192.168.4.1/led/0 and 192.168.4.1/led/1
 * 通过下面的地址读取A0引脚的模拟量值以及IO 12引脚的状态。
 * 192.168.4.1/read
 */
...
// WiFi 密码设置 //
//////////////////////
const char WiFiAPPSK[] = "ESP8266APwifi";
...
void setupWiFi()
{
  ...
  macID.toUpperCase();
  String AP_NameString = "ESP8266 Thing " + macID;//WiFi名称是由ESP8266 Thing +MAC地址组成
  ...
  WiFi.softAP(AP_NameChar, WiFiAPPSK);//设置AP模式
}
